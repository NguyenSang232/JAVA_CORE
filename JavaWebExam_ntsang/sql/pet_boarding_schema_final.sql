...
CREATE TABLE owners (
    ...
    email             VARCHAR(100),
    address           VARCHAR(255),
    total_accumulated DECIMAL(12,2) DEFAULT 0.00, -- Thêm trường tổng tiền tích lũy ở đây
...
-- ── 1. Khách hàng (Owners) ──────────────────────────────────────
-- Đã thêm đầy đủ dữ liệu cho trường total_accumulated
INSERT INTO owners (id, name, phone, email, address, total_accumulated) VALUES
(1, 'Nguyễn Văn An',   '0901234567', 'an@email.com',      '123 Lê Lợi, Q1, TP.HCM',       4000000.00),
(2, 'Trần Thị Bình',   '0912345678', 'binh@email.com',    '45 Nguyễn Huệ, Q1, TP.HCM',     1500000.00),
(3, 'Lê Minh Cường',   '0923456789', 'cuong@email.com',   '78 Trần Hưng Đạo, Q5, TP.HCM',       0.00),
(4, 'Phạm Thị Dung',   '0934567890', 'dung@email.com',    '12 CMT8, Q3, TP.HCM',          6500000.00),
(5, 'Hoàng Văn Em',    '0945678901', 'em@email.com',      '56 Điện Biên Phủ, Q10, TP.HCM',      0.00),
(6, 'Võ Thị Phương',   '0956789012', 'phuong@email.com',  '34 Nam Kỳ Khởi Nghĩa, Q3, TP.HCM',  900000.00);
...
VALUES
-- Record 1: Milo đang gửi (Đang lưu trú, tạm tính theo giá chó lớn 180k/ngày)
(1, 1, '2026-07-15', '2026-07-22 10:00:00', NULL, 180000, NULL, 0, NULL, 'BOARDING', 'Cho ăn 2 lần/ngày, không ăn xúc xích'),

-- Record 2: Buddy đang gửi (Chó nhỏ dưới 10kg -> 120k/ngày)
(2, 3, '2026-07-16', '2026-07-20 12:00:00', NULL, 120000, NULL, 0, NULL, 'BOARDING', 'Dị ứng thức ăn có gà'),

-- Record 3: Snow đang gửi (Thỏ -> 70k/ngày)
(3, 5, '2026-07-17', '2026-07-21 15:00:00', NULL, 70000, NULL, 0, NULL, 'BOARDING', 'Cho ăn rau cải, cà rốt'),

-- Record 4: Max đã trả đúng hạn (7 ngày x 180k = 1.260.000đ)
(4, 6, '2026-05-15', '2026-05-22 09:00:00', '2026-05-22', 180000, 1260000, 0, 1260000, 'RETURNED', ''),

-- Record 5: Kiki đã trả (Mèo -> 100k/ngày. Gửi từ 10 -> 19 là 9 ngày = 900.000đ + phạt trễ 40k)
(5, 2, '2026-05-10', '2026-05-17 12:00:00', '2026-05-19', 100000, 900000, 40000, 940000, 'RETURNED', 'Hay trốn, cẩn thận cửa'),

-- Record 6: Luna đã trả đúng hạn (9 ngày x 100k = 900.000đ)
(6, 7, '2026-05-01', '2026-05-10 10:00:00', '2026-05-10', 100000, 900000, 0, 900000, 'RETURNED', ''),

-- Record 7: Tweety đã trả đúng hạn (7 ngày x 60k = 420.000đ)
(7, 4, '2026-04-10', '2026-04-17 14:00:00', '2026-04-17', 60000, 420000, 0, 420000, 'RETURNED', ''),

-- Record 8: Buddy lần trước gửi đúng hạn (5 ngày x 120k = 600.000đ)
