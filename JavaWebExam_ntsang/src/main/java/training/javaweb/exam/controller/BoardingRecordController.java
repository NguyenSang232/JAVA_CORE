...
public class BoardingRecordController {
	...
	@Operation(summary = "C9 Get all boarding record by me", description = "Lấy danh sách phiếu đang gửi của tôi")
	...
	@Operation(summary = "C10 Get all history by me", description = "Lấy danh sách lịch sử phiếu gửi của tôi")
